...
f = open('multinomial_NB_re.pickle', 'rb')
clf1 = pickle.load(f)
f.close()

f = open('SVM_Text_clf_re.pickle', 'rb')
clf2 = pickle.load(f)
f.close()

with open('train_re.txt') as f:
...
filename = "DataFiles/RetrainedErrorDataFuzz" + str(datetime.datetime.now()) + ".csv"
f = open(filename, "w")
file_writer = csv.writer(f, delimiter=',')

filename1 = "DataFiles/RetrainedErrorData" + str(datetime.datetime.now()) + ".txt"
f1 = open(filename1, "w")
# file_writer1 = csv.writer(f1, delimiter=',')

# filename2 = "DataFiles/Retrain" + str(datetime.datetime.now()) + ".txt"
# f2 = open(filename2, "w")
