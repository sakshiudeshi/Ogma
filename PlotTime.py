...
# src = "DataFiles/MasterData/"+ folder_type + "/"
    ...
    if folder == "MasterData Positive Start":
        os.chdir("/Users/sakshiudeshi/Documents/SUTD/Research/LaTeX/GMLFuzz/figs/master-error-start-time-new")
    else:
        os.chdir("/Users/sakshiudeshi/Documents/SUTD/Research/LaTeX/GMLFuzz/figs/master-non-error-start-time-new")
